...
public class AuctionControlerTests
{
    ...
    public async Task GetAuctionById_WithValidGuid_ReturnsAuction()
    {
        ...
        _auctionRepo.Setup(repo => repo.GetAuctionByIdAsync(AnyGuid)).ReturnsAsync(auction);
        
        //act
        var result = await _controller.GetAuctionById(AnyGuid);
    ...
    public async Task GetAuctionById_WithInvalidGuid_ReturnsNotFound()
    {
        ...
        //arrange
        _auctionRepo.Setup(repo => repo.GetAuctionByIdAsync(AnyGuid))
